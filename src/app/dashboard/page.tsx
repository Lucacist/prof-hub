      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <header className="flex flex-row justify-between">
          ...
          <UserButton
            ...
            appearance={{
              elements: {
                // "userButtonTrigger" cible le bouton rond (l'avatar)
                // "focus:shadow-none" enlève l'ombre Tailwind
                // "focus:outline-none" enlève souvent le contour bleu par défaut aussi
